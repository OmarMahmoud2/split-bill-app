...
class _SignUpModalState extends State<SignUpModal>
  ...
  static const _authSurface = Colors.white;
  static const _authText = Colors.black87;
  static const _authMuted = Color(0xFF6B7280);
  static const _authField = Color(0xFFF9FAFB);
  static const _authFieldBorder = Color(0xFFE5E7EB);
  ...
  Widget _buildTextField({
    ...
    return Container(
      decoration: BoxDecoration(
        color: _authField,
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: _authFieldBorder),
      ),
      child: TextFormField(
